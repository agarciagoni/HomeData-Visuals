...
app.layout=html.Div(style={'backgroundColor':colors['background']},children=[
        ...
        html.Div(id='Sub-Header',className='row',children=[
            html.H2(className='twelve columns',children=dcc.Markdown('Project developed by MIT Media Lab - [City Science](https://www.media.mit.edu/groups/city-science/overview/)'),
          ...
          html.Div(id='left side', className='six columns', children=[           
           ...
           html.Div(id='right side', className='six columns',children=[
                html.H3([
                       ...
                       ,style={'borderColor':'black','backgroundColor':colors['right'],'color':colors['text'],
...
#                                      color="red",
                ...
                style={'color':colors['text'],'display': 'inline-block','padding': '0px 20px 20px 20px','columnCount':1})                              
        ]),                                      
])
@app.callback(
...
#                      mode='lines+markers'
        ...
        fig['layout'].update(height=950, title='Termites',plot_bgcolor=colors['background'],
